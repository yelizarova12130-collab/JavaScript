//                                         // predicate - умова по чому ми будемо фільтрувати масив
//                                         //таким чином ми відфільтруємо наш масив значень і покладемо тільки парні
...
// console.log(filter([11, 22, 33, 44, 55], 'хочу парні'));
                                    ...
                                    //За допомогою callback робимо функцію що б вона могла працювати завжди
